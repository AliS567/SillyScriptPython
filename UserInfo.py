...
print("Dear {} {}, you are {}, {} ft {} inches, {:.2f} kg and you were born in {}. Notice the bold date {}; this is calculated from the data and you could do this from subtracting the age from the current year which (I think) is 2022.".format(Fname, Sname, Age, Feet, inches, WeightKG, DoB, DoB))
